<%-- 
    Document   : settings_user
    Created on : 9 Jun 2025, 12:43:47 pm
...
<body>
    <div class="container">
        ...
        <div class="sidebar" aria-label="User settings navigation">
            <h4>Settings</h4>
<!--            <a href="settings_user.jsp" aria-label="View profile">
                <i class="fas fa-user"></i> View Profile
            </a>-->
            <a href="edit_user.jsp" aria-label="Edit profile">
        ...
        <div class="main-content">
            <%
                ...
                if (userId == null) {
                    ...
                    try {
                        String query = "SELECT u.user_id, u.username, u.fullname, u.email, u.password, u.phone, " +
                                       "u.address, u.city, u.pincode, u.photo, u.role, u.created_at, u.updated_at, " +
                                       "a.has_pets, a.no_of_pets, a.no_of_family_members, a.has_any_allergy, a.allergy_details " +
                                       "FROM Users u LEFT JOIN Adopters a ON u.user_id = a.user_id WHERE u.user_id = ?";
            ...
            <div class="section" id="user-section">
                ...
                <div class="user-card" role="article" aria-label="User profile details">
                    <div class="user-content">
                        <div class="card-header">
                            ...
                            <div class="role-badge">
                                <i class="fas fa-user"></i> <%= rs.getString("role") %>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="card-image-container">
                                <img src='<%= rs.getString("photo") != null ? "user_image/" + rs.getString("photo") : "user_image/default.jpg" %>' alt="User <%= rs.getString("fullname") != null ? rs.getString("fullname") : "Profile" %>" class="card-image">
                            </div>
...
<!--                                <div class="detail-item">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="label">Has Pets:</span>
                                    <span class="value"><%= rs.getString("has_pets") != null ? rs.getString("has_pets") : "N/A" %></span>
                                </div>
                                <div class="detail-item">
                                    <i class="fas fa-dog" aria-hidden="true"></i>
                                    <span class="label">Number of Pets:</span>
                                    <span class="value"><%= rs.getString("no_of_pets") != null ? rs.getString("no_of_pets") : "N/A" %></span>
                                </div>
                                <div class="detail-item">
                                    <i class="fas fa-users" aria-hidden="true"></i>
                                    <span class="label">Family Members:</span>
                                    <span class="value"><%= rs.getString("no_of_family_members") != null ? rs.getString("no_of_family_members") : "N/A" %></span>
                                </div>
                                <div class="detail-item">
                                    <i class="fas fa-allergies" aria-hidden="true"></i>
                                    <span class="label">Has Allergy:</span>
                                    <span class="value"><%= rs.getString("has_any_allergy") != null ? rs.getString("has_any_allergy") : "N/A" %></span>
                                </div>
                                <div class="detail-item">
                                    <i class="fas fa-info-circle" aria-hidden="true"></i>
                                    <span class="label">Allergy Details:</span>
                                    <span class="value"><%= rs.getString("allergy_details") != null ? rs.getString("allergy_details") : "N/A" %></span>
                                </div>
                            </div>
<!--                            <div class="card-actions">
                                <a href="edit_user.jsp?id=<%= rs.getInt("user_id") %>" class="action-btn" aria-label="Edit profile">
                                    <i class="fas fa-edit"></i> Edit Profile
                                </a>
                            </div>-->
                        </div>
            ...
            <%
                            ...
                            out.println("<h3>No Profile Found</h3>");
                            out.println("<p>Your profile could not be found. Please contact support.</p>");
                            out.println("</div>");
                        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log('User Settings Page loaded successfully');
        });
    </script>
</body>
</html>